...
import '../../constant/open_settings.dart';
import '../../utils.dart';
...
class _StatusVideoEditorState extends State<StatusVideoEditor> {
  ...
  _pickVideo() async {
    ...
    if (_video!.lengthSync() / 1000000 > observer.maxFileSizeAllowedInMB) {
      error =
          '${ 'maxfilesize'} ${observer.maxFileSizeAllowedInMB}MB\n\n${'selectedfilesize'} ${(_video!.lengthSync() / 1000000).round()}MB';
