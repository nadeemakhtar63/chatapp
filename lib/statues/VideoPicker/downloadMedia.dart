...
import '../../utils.dart';
import 'DownloadInfoProvider.dart';
  ...
  try {
    ...
    Fiberchat.checkAndRequestPermission(
      ...
      if (res) {
        ...
        Fiberchat.showRationale( 'ps');
        Navigator.pushReplacement(context,
            new MaterialPageRoute(builder: (context) => OpenSettings()));
      }
    });
  } catch (e) {
    Fiberchat.toast('alreadydeleted',
    );
  }
}
