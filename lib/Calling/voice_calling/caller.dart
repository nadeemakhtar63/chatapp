  ...
  void _addAgoraEventHandlers() {
    _engine.setEventHandler(RtcEngineEventHandler(error: (code) {
      ...
      if (widget.currentuseruid == widget.call.callerId) {
        ...
        FirebaseFirestore.instance
            .collection('collectiondashboard').doc('docchatdata').set({
        ...
        children: <Widget>[
          ...
          isshowspeaker == true
            ...
            Icon(
              ...
              color: isspeaker ? Colors.indigo : Colors.greenAccent,
              size: 22.0,
            ),
            shape: CircleBorder(),
            elevation: 2.0,
            fillColor: isspeaker ? Colors.blueAccent : Colors.greenAccent,
            padding: const EdgeInsets.all(12.0),
          )
              : SizedBox(height: 42, width: 42)
        ],
                      ...
                      child: CachedNetworkImage(
                        ...
                        errorWidget: (context, url, error) =>
                            Container(
                              ...
                              color: Colors.white12,
                              child: Icon(
                                status == 'ended' ? Icons.person_off : status == 'rejected' ? Icons.call_end_rounded : Icons.person,
                                size: 140,
                                color: fiberchatDeepGreen,
                              ),
                            ),
